...
**By rule:** uk-spelling (46), product-names (16), punctuation (13), number-formatting (3), house-style (2)
...
- [ ] `7e6369fd0e0a` **Durable** | [uk-spelling] `minimised` → `minimized`
...
- [ ] `0fbed664e9b9` **Run MySQL on any public, private or hybrid cloud** | [uk-spelling] `optimised` → `optimized`
...
- [ ] `0e44bd896031` **1. Deployment** | [uk-spelling] `Specialised` → `Specialized`
...
- [ ] `4c8e12782d1b` **Learn more about Opensearch** | [uk-spelling] `utilise` → `utilize`
...
- [ ] `1733238d6049` **When the size of your data matters** | [uk-spelling] `optimised` → `optimized`
- [ ] `e8417b1fb5f2` **When you have dynamic or changing access patterns** | [uk-spelling] `optimised` → `optimized`
- [ ] `0496b4fa4f51` **When you would like to centralise your data management** | [uk-spelling] `centralise` → `centralize`
- [ ] `e986e3ab2987` **When you would like to centralise your data management** | [uk-spelling] `specialised` → `specialized`
- [ ] `ff31d188c093` **When you would like to centralise your data management** | [uk-spelling] `specialised` → `specialized`
- [ ] `c19ea425e81a` **1969** | [uk-spelling] `specialised` → `specialized`
- [ ] `7bf604a2f231` **[SQL** | [uk-spelling] `optimised` → `optimized`
...
- [ ] `eb7ed7b99a19` **OLAP vs OLTP** | [uk-spelling] `optimised` → `optimized`
...
- [ ] `c36d1ce8b1f0` **NVIDIA GPU support, ideal for AI/ML and HPC** | [uk-spelling] `optimised` → `optimized`
