...
**URL:** https://ubuntu.com/18-04/aws
**Date:** 2026-05-13
**Copydoc:** none found
...
|---|---|---|---|---|
| UX quality check | 10 | 2 | 4 | 4 |

**Total issues:** 10 (2 critical, 4 needs work, 4 minor)
**Total passes:** 10
...
#### Critical
- **[Hero Section: Missing clear value proposition]** - The headline "Ubuntu 18.04 LTS (Bionic Beaver) on Amazon Web Services (AWS)" is informational but lacks urgency.
  - Found: "Ubuntu 18.04 LTS (Bionic Beaver) on Amazon Web Services (AWS)"
...
- **[CTA placement]** - CTAs are somewhat scattered without clear hierarchy.
  - Found: "Upgrade to Ubuntu Pro on AWS", "Get started with Ubuntu Pro", "Watch the webinar"
...
- **[Breadcrumb missing]** - No breadcrumb navigation.
  - Recommendation: Add breadcrumb showing path (Ubuntu > 18.04 > AWS)

#### Needs Work
- **[Internal linking]** - Page could link to related cloud providers.
  - Recommendation: Add links to Azure, GCP, IBM pages
