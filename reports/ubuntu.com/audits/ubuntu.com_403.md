...
**URL:** https://ubuntu.com/403
**Date:** 2026-05-13
**Copydoc:** none found
**Note:** Error page for HTTP 403 Forbidden
...
#### 🔴 Critical
- **[No permission context]** — Page doesn't explain why user doesn't have access
  - *Found:* "We can't show you this page because you don't have the right permissions." | *Recommendation:* Provide specific guidance: "You may need to log in" or "This page requires admin access"

- **[No login option]** — No clear path to log in if authentication is required
  - *Found:* No login link | *Recommendation:* Add "Log in" button if page requires authentication

- **[No recovery guidance]** — Page offers limited options for users to recover from the error
  - *Found:* "file a bug if you think this might be an error" | *Recommendation:* Add more recovery steps: check login status, contact admin, verify URL

- **[No error code explanation]** — HTTP 403 status code is not explained
  - *Found:* "403" displayed prominently | *Recommendation:* Add brief explanation: "This means you don't have permission to view this page"

#### 🟡 Needs Work
- **[No alternative access]** — No suggestion for alternative pages or paths
  - *Found:* Only homepage link | *Recommendation:* Suggest similar public pages or contact options

- **[Technical details hidden]** — No way to see more details about the access restriction
  - *Found:* No error details section | *Recommendation:* Add collapsible section with technical details for debugging

- **[Role-based guidance missing]** — Different user roles may need different solutions
  - *Found:* Generic message | *Recommendation:* Provide role-specific guidance if applicable

#### 🔵 Minor
- **[Page title generic]** — Page title "403: You don't have access to this page" is technical
  - *Found:* "403: You don't have access to this page | Ubuntu" | *Recommendation:* Make more user-friendly with clearer messaging

- **[Visual design minimal]** — Page is very plain, which may increase user frustration
  - *Found:* Minimal error page design | *Recommendation:* Add reassuring visual elements to reduce user anxiety

### CTAs

#### 🔴 Critical
- **[No primary action]** — No clear primary action for users to resolve the issue
  - *Found:* "file a bug" is secondary option | *Recommendation:* Make "Log in" or "Contact support" primary action

- **[File bug link: No context]** — Link to file bug doesn't explain when to use it
  - *Found:* "file a bug if you think this might be an error" | *Recommendation:* Add tooltip or context: "If you believe you should have access"

#### 🟡 Needs Work
- **[Homepage link: Only option]** — Homepage is the only navigation option
...
- **[No contextual links]** — Page lacks links to relevant help resources
  - *Found:* Only bug report link | *Recommendation:* Add links to login, help center, or contact support
...
#### 🟡 Needs Work
- **[No related content]** — Users can't find public pages or alternatives
  - *Found:* No product links | *Recommendation:* Add links to popular public pages
...
#### 🔴 Critical
- **[No login form]** — If login is required, no login form is provided
  - *Found:* No login form | *Recommendation:* Add login form or clear login link
...
- **[No helpful error message]** — Message doesn't help user understand or fix the problem
  - *Found:* "We can't show you this page because you don't have the right permissions." | *Recommendation:* Provide actionable guidance like "Try logging in" or "Contact your administrator"

- **[No retry mechanism]** — Users must manually navigate away
  - *Found:* Manual navigation options | *Recommendation:* Consider auto-redirect if user is logged in but shouldn't be here
...
- **[Heading hierarchy]** — H1 should clearly indicate error state
  - *Found:* "# You don't have access to this page" as H1 | *Recommendation:* Ensure proper heading structure
...
1. **Clear error code display** — The "403" status code is prominently displayed

2. **Permission explanation** — Page explains the issue is about permissions
...
1. Fix all 🔴 Critical issues
   ...
   - Provide login option if authentication required
...
- [ ] **Error reproduction** — Try to reproduce the 403 error to understand triggers
- [ ] **Login functionality** — Test if logging in resolves the issue
